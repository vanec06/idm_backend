...
export const validatorMaqui = [
    ...
    check('estado', 'Estado incorrecto').isIn(['con_mantenimiento', 'calibracion_vigente', 'no_realizado_calibracion','sin_calibracion','dar_baja','no_cuenta_mantenimienton','mantenimiento_correctivo','mantenimiento_preventivo']),
